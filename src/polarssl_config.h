// NOTE: the only difference between this file and polarssl default is we
//   enable havege. when upgrading polarssl versions, completely replace this
//   file and then make sure havege is enabled.
